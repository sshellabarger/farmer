...
/* ─── Component ─── */
/** The v1 admin tabs (users / broadcast / history), moved here unchanged
 *  when /admin became the market dashboard. Admin-only. */
export default function BroadcastPage() {
  ...
  }, [ready, tab, loadUtilization, loadHistory]);
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 py-6">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm mt-1" style={{ color: '#8a7e72' }}>
            v1 users and broadcast text messaging
          </p>
        </div>
