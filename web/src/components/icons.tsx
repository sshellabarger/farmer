...
const paths: Record<string, React.ReactNode> = {
  ...
  market: <><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z" /><polyline points="9 22 9 12 15 12 15 22" /></>,
};

/* Filled icons (separate rendering) */
const filledPaths: Record<string, React.ReactNode> = {
...
export function Icon({ name, size = 18, className, style }: IconProps) {
  if (filledPaths[name]) {
    return (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="1" className={className} style={style}>
        {filledPaths[name]}
      </svg>
    );
  }
